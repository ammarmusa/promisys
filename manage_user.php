                    ...
                    <div class="card-body">
                        ...
                        <div class="data_table">
                            <table id="myTable" class="table table-striped table-bordered" style="width: 100%">
                                ...
                                <?php
                                $retrieve_staff = mysqli_query($conn, "SELECT *
                                FROM users
                                INNER JOIN staff
                                ON users.staff_no = staff.staff_number");
                                ?>
                                <tbody>
                                    <?php
                                    $i = 1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="option" class="form-control" id="exampleRecipientInput">
                                                    <?php
                                                    $data = 'json_user_role.json';
                                                    $json = json_decode(file_get_contents($data), true);
                                                    foreach ($json as $foo) {
                                                        $role = $foo['value'];
                                                        echo $role;
                                                    ?>
                                                        <option value="<?= $foo['value'] ?>" <?php if ($role == $rows['role']) {
                                                                                                    echo "selected";
                                                                                                } ?>><?= $foo['name'] ?></option>
                                                    <?php
                                                    }
