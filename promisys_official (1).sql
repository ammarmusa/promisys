...
INSERT INTO `quotation` (`quot_id`, `quot_no`, `quot_no_inc`, `quot_app_date`, `quot_branch`, `quot_proj_state`, `quot_title`, `quot_pic`, `quot_client_type`, `quot_client_status`, `quot_work_scope`, `quot_client`, `quot_client_pic`, `quot_client_phone`, `quot_client_email`, `quot_sub_deadline`, `quot_market_segmentation`, `quot_proj_duration`, `quot_site_location`, `quot_amount`, `quot_amount_tax`, `quot_status`, `quot_remark`, `quot_type`) VALUES
...
INSERT INTO `securement` (`s_id`, `s_quot_no`, `s_proj_no`, `s_proj_code`, `s_branch`, `s_proj_pic`, `s_award_date`, `s_status`, `s_year`, `s_no_inc`, `s_checklist`) VALUES
(1, 'SGS(J).22Q005', 'SGS(J).22J001', 'TNB JALAN MASAI 2', 'Johor', 'NSNC', '2022-01-20', 'pending', '', '001', ''),
(5, 'SGS.24Q001', 'SGS.23V002', '', 'HQ', '', '2023-06-24', 'pending', '', '002', ''),
(7, 'SGS(J).23Q044', 'SGS(J).23J001', 'TNB MRSM MERSING', 'Johor', 'MDL', '2023-01-16', 'pending', '', '001', ''),
(8, 'SGS(J).23Q045', 'SGS(J).23J002', 'TNB KLUANG', 'Johor', 'NSNC', '2023-02-12', 'pending', '', '002', ''),
(9, 'SGS(J).23Q046', 'SGS(J).23J003', 'TMP SSU PASAK INDAH - SS ASAHI', 'Johor', 'MDL', '2023-02-21', 'pending', '', '003', ''),
(10, 'SGS(J).23Q047', 'SGS(J).23J004', 'TNB TAMAN SEMBRONG', 'Johor', 'MDL', '2023-03-05', 'pending', '', '004', ''),
(11, 'SGS(J).23Q007', 'SGS(J).23J005', '304 TG KUPANG', 'Johor', 'NSNC', '2023-03-08', 'pending', '', '005', ''),
(12, 'SGS(J).23Q008', 'SGS(J).23J006', 'SDE EXPRESSWAY', 'Johor', 'NSNC', '2023-03-09', 'pending', '', '006', ''),
(13, 'SGS(J).23Q019', 'SGS(J).23J007', 'UUM PENGERANG', 'Johor', 'MDL', '2023-04-20', 'pending', '', '007', ''),
(14, 'SGS(J).23Q028', 'SGS(J).23J008', 'PTP PLOT 39A, 39B & 38C', 'Johor', 'NSNC', '2023-05-25', 'pending', '', '008', ''),
(15, 'SGS(J).23Q027', 'SGS(J).23J009', 'JKR DAIF SKKM', 'Johor', 'MDL', '2023-05-31', 'pending', '', '009', ''),
(16, 'SGS(J).23Q048', 'SGS(J).23J010', 'PMU PEKAN NENAS', 'Johor', 'NSNC', '2023-07-13', 'pending', '', '010', ''),
(17, 'SGS(J).23Q039', 'SGS(J).23J011', 'PTP DW4', 'Johor', 'MDL', '2023-07-20', 'pending', '', '011', '');
...
(3, 'JHR065', 'itsammarmusa@gmail.com', 'admin', 'JHR065', 'd838784765060f867aa05ddcf33c899d', 'MUHAMMAD AMMAR BIN MUSA', 'MAM', 'true', '2023-04-27 02:14:17', '', 'Active'),
...
--
ALTER TABLE `clients`
  MODIFY `client_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
ALTER TABLE `log`
  MODIFY `log_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;
...
--
ALTER TABLE `quotation`
  MODIFY `quot_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
...
--
ALTER TABLE `securement`
  MODIFY `s_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
