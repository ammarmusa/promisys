...
?>
    <?php if ($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'superuser') { ?>
        ...
        if ($_SESSION['role'] == 'superuser') {
            ...
            $sql_stm = "SELECT * FROM quotation WHERE YEAR(quot_app_date) = '$year'";
        } else {
            $sql_stm = "SELECT * FROM quotation WHERE quot_branch= '$branch' AND YEAR(quot_app_date) = '$year'";
        }
        ?>
        <div class="row">
            <div class="col-md-12 mb-3 mt-3">
                <div class="card">
                    <div class="card-header">
                        <span><i class="bi bi-table me-2"></i>Quotation list</span>
